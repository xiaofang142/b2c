...
$sql = "
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_adv') . " (
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_carrier') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_category') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_commission_apply') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_commission_clickcount') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_commission_level') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_commission_log') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_commission_shop') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `mid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_designer') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_dispatch') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_express') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_feedback') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_goods') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_goods_comment') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_goods_option') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(10) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_goods_param') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(10) DEFAULT '0',
  `title` varchar(50) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_goods_spec') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_goods_spec_item') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_member') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_member_address') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(50) DEFAULT '0',
  `realname` varchar(20) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_member_cart') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_member_favorite') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(10) DEFAULT '0',
  `openid` varchar(50) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_member_group') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_member_history') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(10) DEFAULT '0',
  `openid` varchar(50) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_member_level') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `level` int(11) DEFAULT '0',
  `levelname` varchar(50) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_member_log') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_member_message_template') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_notice') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `displayorder` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_order') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(50) DEFAULT '',
  `agentid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_order_comment') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_order_goods') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `orderid` int(11) DEFAULT '0',
  `goodsid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_order_refund') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `orderid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_perm_log') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT '0',
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_perm_plugin') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_perm_role') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_perm_user') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `uid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_plugin') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `displayorder` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_poster') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_poster_log') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_poster_qr') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_poster_scan') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `posterid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_saler') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_store') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_sysset') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `sets` text,
  `plugins` text,
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_creditshop_adv') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `advname` varchar(50) DEFAULT '',
  `link` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_creditshop_category') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0' COMMENT '所属帐号',
  `name` varchar(50) DEFAULT NULL COMMENT '分类名称',
  `thumb` varchar(255) DEFAULT NULL COMMENT '分类图片',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_creditshop_goods') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `displayorder` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_creditshop_log') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `logno` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_virtual_category') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0' COMMENT '所属帐号',
  `name` varchar(50) DEFAULT NULL COMMENT '分类名称',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_virtual_data') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS  " . tablename('ycs_fxshop_virtual_type') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `cate` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS  " . tablename('ycs_fxshop_designer_menu'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_article'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_article_category'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_article_log'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_article_report'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_article_share'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('ycs_fxshop_article_sys'). " (
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO " . tablename('ycs_fxshop_plugin') . " (`id`, `displayorder`, `identity`, `name`, `version`, `author`, `status`) VALUES
...
if(!pdo_fieldexists('ycs_fxshop_member', 'agentblack')) {
	pdo_query("ALTER TABLE ".tablename('ycs_fxshop_member')." ADD    `agentblack` tinyint(3) DEFAULT '0';");
}

 if(pdo_fieldexists('ycs_fxshop_goods', 'cates')) {
	pdo_query("ALTER TABLE ".tablename('ycs_fxshop_goods')." CHANGE  `cates`  `ccates` text;");
}

 if(!pdo_fieldexists('ycs_fxshop_goods', 'pcates')) {
	pdo_query("ALTER TABLE ".tablename('ycs_fxshop_goods')." ADD   `pcates` text;");
}
 if(!pdo_fieldexists('ycs_fxshop_goods', 'cates')) {
	pdo_query("ALTER TABLE ".tablename('ycs_fxshop_goods')." ADD   `cates` text;");
}
 if(!pdo_fieldexists('ycs_fxshop_goods', 'tcates')) {
	pdo_query("ALTER TABLE ".tablename('ycs_fxshop_goods')." ADD    `tcates` text;");
}
 if(!pdo_fieldexists('ycs_fxshop_goods', 'artid')) {
	pdo_query("ALTER TABLE ".tablename('ycs_fxshop_goods')." ADD    `artid` int(11) DEFAULT '0';");
}
 if(!pdo_fieldexists('ycs_fxshop_goods', 'detail_logo')) {
	pdo_query("ALTER TABLE ".tablename('ycs_fxshop_goods')." ADD   `detail_logo` varchar(255) DEFAULT '';");
}
 if(!pdo_fieldexists('ycs_fxshop_goods', 'detail_shopname')) {
	pdo_query("ALTER TABLE ".tablename('ycs_fxshop_goods')." ADD   `detail_shopname` varchar(255) DEFAULT '';");
}
 if(!pdo_fieldexists('ycs_fxshop_goods', 'detail_btntext1')) {
	pdo_query("ALTER TABLE ".tablename('ycs_fxshop_goods')." ADD  `detail_btntext1` varchar(255) DEFAULT '';");
}
 if(!pdo_fieldexists('ycs_fxshop_goods', 'detail_btnurl1')) {
	pdo_query("ALTER TABLE ".tablename('ycs_fxshop_goods')." ADD   `detail_btnurl1` varchar(255) DEFAULT '';");
}
 if(!pdo_fieldexists('ycs_fxshop_goods', 'detail_btntext2')) {
	pdo_query("ALTER TABLE ".tablename('ycs_fxshop_goods')." ADD   `detail_btntext2` varchar(255) DEFAULT '';");
}
 if(!pdo_fieldexists('ycs_fxshop_goods', 'detail_btnurl2')) {
	pdo_query("ALTER TABLE ".tablename('ycs_fxshop_goods')." ADD  `detail_btnurl2` varchar(255) DEFAULT '';");
}
 if(!pdo_fieldexists('ycs_fxshop_goods', 'detail_totaltitle')) {
	pdo_query("ALTER TABLE ".tablename('ycs_fxshop_goods')." ADD   `detail_totaltitle` varchar(255) DEFAULT '';");
}

 if(!pdo_fieldexists('ycs_fxshop_order', 'address')) {
	pdo_query("ALTER TABLE ".tablename('ycs_fxshop_order')." ADD  `address` text;");
}
 if(!pdo_fieldexists('ycs_fxshop_order', 'sysdeleted')) {
	pdo_query("ALTER TABLE ".tablename('ycs_fxshop_order')." ADD  `sysdeleted` tinyint(3) DEFAULT '0';");
}

 if(!pdo_fieldexists('ycs_fxshop_order_goods', 'nocommission')) {
	pdo_query("ALTER TABLE ".tablename('ycs_fxshop_order_goods')." ADD   `nocommission` tinyint(3) DEFAULT '0';");
}