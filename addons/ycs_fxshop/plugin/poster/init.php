...
if (!pdo_tableexists('ycs_fxshop_poster')) {
	$sql = 'CREATE TABLE IF NOT EXISTS ' . tablename('ycs_fxshop_poster') . ' (
	...
	pdo_query($sql);
	$sql = 'CREATE TABLE IF NOT EXISTS ' . tablename('ycs_fxshop_poster_log') . ' (
	      `id` int(11) NOT NULL AUTO_INCREMENT,
	      `uniacid` int(11) DEFAULT \'0\',
	...
	pdo_query($sql);
	$sql = 'CREATE TABLE  IF NOT EXISTS ' . tablename('ycs_fxshop_poster_qr') . ' (
	      `id` int(11) NOT NULL AUTO_INCREMENT,
	...
	$sql = 'CREATE TABLE  IF NOT EXISTS  ' . tablename('ycs_fxshop_poster_scan') . ' (
	      `id` int(11) NOT NULL AUTO_INCREMENT,
	      `uniacid` int(11) DEFAULT \'0\',
	      `posterid` int(11) DEFAULT \'0\',
	      `openid` varchar(255) DEFAULT \'\',
...
if (!pdo_fieldexists('ycs_fxshop_poster', 'paytype')) {
	pdo_query('ALTER TABLE ' . tablename('ycs_fxshop_poster') . ' ADD `paytype` tinyint(1) DEFAULT \'0\';');
}
pdo_update('ycs_fxshop_plugin', array('version' => 1.1), array('identity' => 'poster'));